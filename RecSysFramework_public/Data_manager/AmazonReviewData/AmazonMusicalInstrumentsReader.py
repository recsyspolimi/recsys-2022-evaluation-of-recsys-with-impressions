...
class AmazonMusicalInstrumentsReader(_AmazonReviewDataReader):

    DATASET_URL_RATING = "http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/ratings_Musical_Instruments.csv"
    DATASET_URL_METADATA = "http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/meta_Musical_Instruments.json.gz"

    DATASET_SUBFOLDER = "AmazonReviewData/AmazonMusicalInstruments/"
    ...
    def _load_from_original_file(self):
        ...
        metadata_path = self._get_ICM_metadata_path(data_folder = dataset_split_folder,
                                                    compressed_file_name = "meta_Musical_Instruments.json.gz",
                                                    decompressed_file_name = "meta_Musical_Instruments.json",
