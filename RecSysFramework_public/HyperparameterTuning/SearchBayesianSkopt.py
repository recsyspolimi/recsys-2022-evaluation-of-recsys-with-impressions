...
@author: Emanuele Chioso, Anonymous
"""
...
class SearchBayesianSkopt(SearchAbstractClass):
    ...
    def search(self, recommender_input_args,
        ...
        try:
            ...
            metadata_exists = self.metadata_dict["hyperparameters_best"] is not None
            evaluate_last = self.recommender_input_args_last_test is not None

            if metadata_exists and evaluate_last:
            ...
            # self._write_log("{}: Search interrupted due to ValueError. The evaluated configurations may have had all "
